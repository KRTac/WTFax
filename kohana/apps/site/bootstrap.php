...
Route::set('user_registration', 'registracija(/<action>)')
	->defaults(array(
		'controller' => 'profil',
		'action'     => 'registracija',
	));

Route::set('profil', '<action>(/<id>(/<hash>))', array(
		'id' => '[0-9]+',
		'action' => '(prijava|odjava|postavke|potvrda_identiteta|potvrda_emaila)',
	))
	->defaults(array(
		'controller' => 'profil',
	));

Route::set('password', 'lozinka(/<action>(/<id>(/<hash>)))', array(
		'id' => '[0-9]+',
	))
	->defaults(array(
		'controller' => 'lozinka',
